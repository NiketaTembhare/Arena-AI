...
import { Play, Trophy, Settings, Sparkles, Shield, Cpu } from 'lucide-react';
import { audioEngine } from '../game/audioEngine';

export const HomeView = ({ onLeaderboard, onHostConsole, onScreenDisplay }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-12 flex flex-col items-center justify-center min-h-[calc(100vh-100px)] text-center relative z-10">
      ...
      {/* Expo Hero Badge */}
      <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-cyan-500/10 border border-cyan-400/50 text-cyan-300 font-mono text-xs sm:text-sm tracking-widest uppercase mb-8 shadow-[0_0_25px_rgba(0,240,255,0.25)] animate-pulse">
      ...
      {/* Tagline */}
      <p className="font-sub font-bold text-xl sm:text-3xl text-gradient-cyan tracking-widest uppercase mb-14 max-w-2xl">
      ...
      <div className="flex flex-col gap-5 w-full max-w-md">
        ...
        >
          ...
          <span>HOST GAME (START MATCH)</span>
        </button>
